...
//         => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;initial catalog=TeleBill;Trusted_Connection=True;MultipleActiveResultSets=true;TrustServerCertificate=True;Integrated Security=true");
