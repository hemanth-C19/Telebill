...
//         => optionsBuilder.UseSqlServer("Server=LTIN717835\\SQLEXPRESS;initial catalog=TeleBill;Trusted_Connection=true;MultipleActiveResultSets=true;TrustServerCertificate=true;Integrated Security=true");
