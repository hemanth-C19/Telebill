...
namespace Telebill.Controllers.MasterData
{
    ...
    public class PayerController : ControllerBase
    {
        ...
        {
            var plans = await _payerService.GetPlansByPayerIdAsync(payerId);
            return Ok(plans);
        }
        ...
        {
            var planNames = await _payerService.GetPlanNamesByPayerIdAsync(payerId);
            return Ok(planNames);
        }
        ...
        {
            var fees = await _payerService.GetFeesByPlanIdAsync(planId);
            return Ok(fees);
        }
        ...
        {
            await _payerService.AddPlanAsync(plan);
        ...
        {
            await _payerService.UpdatePlanAsync(plan);
        ...
        {
            await _payerService.DeletePlanAsync(planId);
        ...
        {
            await _payerService.AddFeeAsync(fee);
        ...
        {
            await _payerService.UpdateFeeAsync(fee);
        ...
        {
            await _payerService.DeleteFeeAsync(feeId);
